...
var BindingKeys = /** @class */ (function () {
    ...
    BindingKeys.NETWORK_HELPER_FACTORY = '@next/infra/network_helper_factory';
    BindingKeys.NEXT_DATA_PROVIDER_PROVIDER = '@next/infra/next_data_provider_provider';
    BindingKeys.RESPONSE_HANDLER_DATA_PROVIDER = '@next/infra/response_handler_data_provider';
