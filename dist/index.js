...
server_logger_helper_1.applicationLogger.info('------------------------------------');
server_logger_helper_1.applicationLogger.info('Application configures:');
server_logger_helper_1.applicationLogger.info('- Env: %s | Run mode: %s', NODE_ENV, RUN_MODE);
server_logger_helper_1.applicationLogger.info('- Name: %s', APP_ENV_APPLICATION_NAME);
server_logger_helper_1.applicationLogger.info('- Data Provider: %s', APP_ENV_DATA_PROVIDER_IDENTIFIER);
server_logger_helper_1.applicationLogger.info('- Send base url: %s', APP_ENV_SEND_BASE_URL !== null && APP_ENV_SEND_BASE_URL !== void 0 ? APP_ENV_SEND_BASE_URL : 'N/A');
server_logger_helper_1.applicationLogger.info('------------------------------------');
