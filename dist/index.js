...
var _a = process.env, NODE_ENV = _a.NODE_ENV, RUN_MODE = _a.RUN_MODE, APP_ENV_SEND_BASE_URL = _a.APP_ENV_SEND_BASE_URL, APP_ENV_DATA_PROVIDER_IDENTIFIER = _a.APP_ENV_DATA_PROVIDER_IDENTIFIER, _b = _a.APP_ENV_APPLICATION_NAME, APP_ENV_APPLICATION_NAME = _b === void 0 ? 'NextJS Infrastructure' : _b;
...
helpers_1.applicationLogger.info('- Data Provider: %s', APP_ENV_DATA_PROVIDER_IDENTIFIER !== null && APP_ENV_DATA_PROVIDER_IDENTIFIER !== void 0 ? APP_ENV_DATA_PROVIDER_IDENTIFIER : 'Base');
