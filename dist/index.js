...
if (!common_1.DataProviders.isValid(NEXT_PUBLIC_APP_ENV_DATA_PROVIDER_IDENTIFIER)) {
    throw (0, utilities_1.getError)({ message: 'Invalid data provider' });
}
tsyringe_1.container.register(common_1.BindingKeys.DATA_PROVIDER_IDENTIFIER, { useValue: NEXT_PUBLIC_APP_ENV_DATA_PROVIDER_IDENTIFIER });
tsyringe_1.container.register(common_1.BindingKeys.APPLICATION_SEND_BASE_URL, { useValue: NEXT_PUBLIC_APP_ENV_SEND_BASE_URL !== null && NEXT_PUBLIC_APP_ENV_SEND_BASE_URL !== void 0 ? NEXT_PUBLIC_APP_ENV_SEND_BASE_URL : '' });
